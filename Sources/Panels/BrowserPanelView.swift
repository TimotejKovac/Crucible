...
struct BrowserPanelView: View {
    ...
    private var browserMuteButton: some View {
        Button(action: {
            ...
            CmuxSystemSymbolImage(systemName: panel.isAudioMuted ? "speaker.slash.fill" : "speaker.wave.2.fill", pointSize: devToolsButtonIconSize, weight: .medium)
                .foregroundStyle(panel.isAudioMuted ? Color.red : devToolsColorOption.color)
                .frame(width: addressBarButtonSize, height: addressBarButtonSize, alignment: .center)
        }
        .buttonStyle(OmnibarAddressButtonStyle())
        .frame(width: addressBarButtonSize, height: addressBarButtonSize, alignment: .center)
    ...
    private var viewportDeviceButton: some View {
        Button(action: {
            ...
            CmuxSystemSymbolImage(systemName: panel.viewportDevicePreset.iconName, pointSize: devToolsButtonIconSize, weight: .medium)
                .foregroundStyle(panel.viewportDevicePreset.isResponsive ? devToolsColorOption.color : Color.accentColor)
                .frame(width: addressBarButtonSize, height: addressBarButtonSize, alignment: .center)
        }
        .buttonStyle(OmnibarAddressButtonStyle())
        .frame(width: addressBarButtonSize, height: addressBarButtonSize, alignment: .center)
    ...
    private var viewportLandscapeToggle: some View {
        Button(action: {
            ...
            CmuxSystemSymbolImage(systemName: "rectangle.landscape.rotate", pointSize: devToolsButtonIconSize, weight: .medium)
                .foregroundStyle(panel.viewportLandscape ? Color.accentColor : devToolsColorOption.color)
                .frame(width: addressBarButtonSize, height: addressBarButtonSize, alignment: .center)
        }
        .buttonStyle(OmnibarAddressButtonStyle())
        .frame(width: addressBarButtonSize, height: addressBarButtonSize, alignment: .center)
